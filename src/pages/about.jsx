...
export default function Test() {
  return <main>
    ...
    <section id="aboutsection" class="bg-hero-pattern pt-10 pb-40 text-white">
      ...
      <div className="flex flex-col justify-center space-x-8 md:flex-row mx-14 md:mx-0">
        <div className="flex flex-col justify-center items-center w-80 text-center">
          ...
          <p className="text-xl font-bold flex text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-orange-200 hover:from-orange-600 hover:to-orange-300"> ◌ Expert on nebulas and dark matter ◌</p>
          <p className="hover:opacity-90"> Loves taking long walks, especially at nighttime to look up at the sky wishing for supernovas.
            With 100 years of experience, the astronauts are in good hands when this woman takes the lead.</p>
          <a className=" flex text-xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-orange-500 to-orange-200 hover:from-orange-600 hover:to-orange-300"
            href="https://github.com/Erilzor"><BsGithub className="text-orange-400 text-2xl mr-2"/>Erilzor</a>
          <a className="bg-gradient-to-r from-orange-500 to-orange-200 hover:from-orange-600 hover:to-orange-300
                 text-black text-xl mt-10 border-solid-white border-2 p-2 rounded-md flex flex-row" href="mailto:jennifer.bjorklund@edu.newton.se" class="button">Contact me <GoMail className="mx-2 my-1.5"/></a>
        </div>
        ...
        <div className="flex flex-col justify-center items-center w-80 text-center ">
          ...
          <a className="bg-gradient-to-r from-orange-500 to-orange-200 hover:from-orange-600 hover:to-orange-300
                 text-black text-xl mt-10 border-solid-white border-2 p-2 rounded-md flex flex-row" href="mailto:john.doe@edu.newton.se" class="button">Contact me <GoMail className="mx-2 my-1.5"/></a>
        </div>
      </div>
    </section>
